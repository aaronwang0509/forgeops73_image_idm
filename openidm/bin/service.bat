...
:: Concatenate all variables together and replace all whitespace with semi-colons later
:noIdmOpts
set "JAVA_OPTS_SERVICE=%JAVA_OPTS%%LOGGING_CONFIG%%OPENIDM_OPTS_SERVICE%"
